...
function SavedBuild({build, dataId, last, history, handleUpClick, handleDownClick, setDeleteAlert}){
				...
				<Accordion>
					<Card>
						...
						<Accordion.Collapse eventKey={build._id}>
							<Card.Body>
								<BuildDisplay build={build} history={history} search={search} setDeleteAlert={setDeleteAlert}/>
							</Card.Body>
						</Accordion.Collapse>
					</Card>
				</Accordion>
