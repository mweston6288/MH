...
function SavedBuild({build, dataId, history}){
					...
					<Container>
						<Row style={{float:"right"}}>
							<Button variant="link" style={{padding:"0px"}} onClick={handleUpClick}>
								<i class="fa fa-angle-up" style={{ fontSize: "2em", color: "black" }} value={dataId}/>
							</Button>
						</Row>
						<Row style={{ clear: "both",float: "right" }}>
							<Button variant="link" style={{ padding: "0px" }}>
								<i class="fa fa-angle-down" style={{ fontSize: "2em", color: "black" }} value={dataId}/>
							</Button>
						</Row>
					</Container>
				</Col>
